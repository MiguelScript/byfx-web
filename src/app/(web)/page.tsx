	...
	return (
		<>
			...
			<div className="flex flex-col grow xl:px-48">
				<div className="lg:pt-8 font-mono grow flex flex-col tracking-[0.015em] text-5xl xl:text-7xl xl:leading-[60px] max-w-md 2xl:text-8xl 2xl:leading-[100px] 2xl:max-w-xl">
